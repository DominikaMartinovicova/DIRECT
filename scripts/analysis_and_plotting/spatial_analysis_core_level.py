...
#+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
#
#   Analyze spatial proximity of cell types on core- or tissue piece-level.
#
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(prog = 'python3 spatial_analysis_core_level.py',
...
core = os.path.basename(args.input).replace('.h5ad','')
